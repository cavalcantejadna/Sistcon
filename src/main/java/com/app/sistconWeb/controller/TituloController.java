...
import com.app.sistconWeb.service.TituloService;
...
public class TituloController {
    ...
    public ModelAndView pesquisar(@ModelAttribute("filtro") TituloFilter filtro) {
        ...
        System.out.println("jfhgfg");
        ModelAndView mv = new ModelAndView("dashboard/PesquisaTitulos");
    ...
    public String excluir(@PathVariable Long codigo, RedirectAttributes attributes) {
        ...
        attributes.addFlashAttribute("mensagem", "Título exluido com sucesso!");
